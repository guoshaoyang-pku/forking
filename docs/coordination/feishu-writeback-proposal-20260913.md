...
<p>以下状态来自仓库 commit 9659e64、0b7ff4a、884944a 及对应 evidence packet。原有会议 checkbox 保留为历史记录；当前排程以 docs/coordination/overnight-queue-20260913.md 和机器可读的 overnight-dispatch-manifest.json 为准。</p>
<table>
