# Experiment log contents index

> Generated from top-level headings in docs/experiment-log.md; historical status text remains in sections.
...
- L869: 12. epoch 对齐批（同 epoch 数 × 同 LR-per-epoch 轨迹，2026-08-07；历史）
...
- L3947: §53 · 置信度极化探针 + 20-epoch logit-sharpening 直接验证（2026-09-12；done）
